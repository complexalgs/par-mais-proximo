...
function setup() {
  ...
  //   pontos[2] = createVector(900, 140);
  //   pontos[3] = createVector(800, 170);
  ...
  maisProximos = parMaisProximo(Px, Py); // maisProximos recebe inicialmente o valor de Px e Py e vai sendo reduzido com o retorno dessa função recursiva 
}
...
function parMaisProximo(Px, Py) { // 
  ...
  var proxEsq = parMaisProximo(esqX, esqY);  // (esqX, esqY) chama recursivamente a função parMaisProximo() e define o par de pontos mais proximos na esquerda
  console.log("Proximos esquerda:");
  listaPontos(proxEsq); 
  
  console.log("+");
  
  var proxDir = parMaisProximo(dirX, dirY); // (dirX, dirY) chama recursivamente a função parMaisProximo() e define o par de pontos mais proximos na direita
